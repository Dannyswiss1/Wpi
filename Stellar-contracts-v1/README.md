...
| Volume-limit admin | `VolumeLimitAdmin` | `configure_volume_limits`, `configure_max_mint_per_tx`, `override_volume_limit`, `set_volume_limit_admin` | Current volume-limit admin only |
